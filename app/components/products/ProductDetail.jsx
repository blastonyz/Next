...
export const ProductDetail = async ({id}) => {
  console.log('detail id', id);
    ...
    const item = await fetch(`http://${process.env.VERCEL_URL}/api/producto/${id}`,{cache:"no-store"}).then(r => r.json()).catch(Error)
...
export const ProductDetail = async ({id}) => {
  console.log('detail id', id);
try{
    const response = await fetch(`http://${process.env.VERCEL_URL}/api/producto/${id}`,{cache:"no-store"})
